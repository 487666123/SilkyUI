...
public class AnimationTimer(float speed = 5f, float timerMax = 100f)
{
    ...
    public bool IsForward => Status is AnimationTimerStaus.ForwardUpdating or AnimationTimerStaus.ForwardUpdateCompleted;
    ...
    public bool IsReverse => Status is AnimationTimerStaus.ReverseUpdating or AnimationTimerStaus.ReverseUpdateCompleted;
