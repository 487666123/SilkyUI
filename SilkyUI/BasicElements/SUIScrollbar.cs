...
public class SUIScrollbar : View
{
    ...
    {
        get => Vector2.Clamp(_targetScrollPosition * ScrollMultiplier, Vector2.Zero, GetScrollRange());
        set
        {
            StartScrollPosition = CurrentScrollPosition;
            ScrollTimer.StartForwardUpdateAndReset();
            _targetScrollPosition = Vector2.Clamp(value * ScrollMultiplier, new Vector2(-500f),
    ...
    public readonly AnimationTimer ScrollTimer = new(10f);
